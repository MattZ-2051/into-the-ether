...
describe("NFTMarket", function () {
  it("Should create and execute a marketplace sale", async function () {
    ...
    await market.createItem(nftContractAddress, 1, auctionPrice, {
      value: listingPrice,
    });
    await market.createItem(nftContractAddress, 2, auctionPrice, {
      value: listingPrice,
    });
    ...
    await market
      ...
      .createSale(nftContractAddress, 1, { value: auctionPrice });
